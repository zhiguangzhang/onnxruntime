...
namespace {
std::vector<uint8_t> GetStream(std::string countryName = "") {
  dft::DateTimeTransformer dt(countryName, "C:\\Users\\Administrator\\Desktop\\ORT\\datetime\\build\\Windows\\RelWithDebInfo\\external\\FeaturizersLibrary\\");
...
TEST(FeaturizersTests, DateTimeTransformer_Country_Canada) {
  ...
  dft::DateTimeTransformer dt("Canada", "C:\\Users\\Administrator\\Desktop\\ORT\\datetime\\build\\Windows\\RelWithDebInfo\\external\\FeaturizersLibrary\\");
  dft::TimePoint tp = dt.execute(date_tp);
