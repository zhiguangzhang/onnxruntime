...
TEST(ExecutionProviderTest, FunctionTest) {
  ...
  graph.AddNode("valuenode_1", "Add", "node 1.", inputs, outputs);
  ...
  graph.AddNode("valuenode_2", "Add", "node 2.", inputs, outputs);
...
TEST(ExecutionProviderTest, FunctionInlineTest) {
  ...
  outputs.push_back(&output_arg);
  graph.AddNode("valuenode_1", "FC", "node 1.", inputs, outputs);
