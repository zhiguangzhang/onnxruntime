  ...
  Status Compute(OpKernelContext* ctx) const override {
    ...
    Microsoft::Featurizer::Featurizers::DateTimeTransformer transformer(
        [ctx](void) {
          ...
          return Microsoft::Featurizer::Featurizers::DateTimeTransformer(archive, "C:\\Users\\Administrator\\Desktop\\ORT\\datetime\\build\\Windows\\RelWithDebInfo\\external\\FeaturizersLibrary\\");
        }());
