...
parser.add_argument('--ckpt_dir', type=str, default='checkpoints', help='storage to ckpts.')
...
script_params = {
  '--input_dir': ds.path(args.train_dir).as_mount(),
  '--output_dir': ds.path(args.ckpt_dir).as_mount()
}
...
#estimator._estimator_config.environment.python.interpreter_path = '/opt/conda/bin/python'
